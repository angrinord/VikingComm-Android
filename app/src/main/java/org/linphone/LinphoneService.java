...
public final class LinphoneService extends Service {
    ...
    */
    ...
    public static LinkedList<ScheduleObject> deserializeSchedule(Context c) {
        LinkedList<ScheduleObject> schedule;
        try {
            FileInputStream fis = c.openFileInput("schedule.ser");
    ...
    public boolean shouldAcceptCalls() {
        ...
        boolean shouldAcceptCall = true;
        LocalTime t = new LocalTime();

        for (ScheduleObject s : schedule) {
            if (!s.shouldAcceptCall(t, day)) {
